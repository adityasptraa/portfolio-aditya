...
>
  {/* Gambar akan tampil dulu di layar kecil */}
  <div className="w-full flex flex-col justify-center items-center lg:items-end pt-5 lg:pt-0 order-1 lg:order-2">
    <motion.img
  ...
  {/* Text About Me */}
  <div className="w-full flex flex-col items-center lg:items-start justify-center pt-5 lg:pt-0 order-2 lg:order-1">
    <motion.h1
      whileInView={{ opacity: 1, x: 0 }}
      initial={{ opacity: 0, x: -100 }}
      transition={{ duration: 0.7 }}
    ...
    <motion.span
      ...
      transition={{ duration: 0.7 }}
      className="w-full text-sm md:text-lg lg:text-xl text-slate-700 dark:text-neutral-400 pt-2 text-justify"
    >
      {aboutMe.description}
    </motion.span>
